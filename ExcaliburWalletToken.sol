...
contract ExcaliburWalletToken is Ownable, ERC20 {
    ...
    constructor(uint256 _totalSupply) ERC20("Excalibur Wallet Token", "EXBR") {
        _mint(msg.sender, _totalSupply);
        taxFees = TaxFees(35, 35, 1); // These taxfees will be reset after the initial entrance. This is just to fend of sniping bots
    }

    function setUniSawpV2Pair(address _uniswapV2Pair) external onlyOwner {
    ...
    // These taxes are only stored in the smart contract and used by the Excalibur Wallet app to do the buying, selling and swapping in app
    ...
    function transfer(address recipient, uint256 amount) public virtual override(ERC20) returns (bool) {
        ...
        bool takeFees = true;
        // Sending to specialWallets is taxfree
